...
- (void)setMsgContent:(NSString *)str
{
    ...
    _tipLabel.text = str;
    CGSize aSize = [Common getContentSize:str withCGSize:CGSizeMake(_tipLabel.frame.size.width, 1000) withSystemFontOfSize:14.0f];
    _tipLabel.frame = CGRectMake(_tipLabel.frame.origin.x, 5, _tipLabel.frame.size.width, aSize.height + 4);
}
...
{
    float height = 0.0f;
    height = [Common getContentSize:str withCGSize:CGSizeMake(240, 1000) withSystemFontOfSize:14.0f].height;
    height += 14;
