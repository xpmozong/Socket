...
#pragma mark--  自定义取消菊花按钮
    UIButton *b = [UIButton buttonWithType:UIButtonTypeCustom];
    [b setImage:[UIImage imageNamed:@"page_close"] forState:UIControlStateNormal];
    b.frame = CGRectMake(0, 0, 40, 40);
    [b addTarget:self action:@selector(bbb) forControlEvents:UIControlEventTouchUpInside];
//    [self.indicator.superview addSubview:b];
//    if (isIos7)
        [b setCenter:CGPointMake(self.indicator.superview.center.x+21, self.indicator.superview.center.y-20)];
//    else
     //   [b setCenter:CGPointMake(self.indicator.sup, <#CGFloat y#>)];
